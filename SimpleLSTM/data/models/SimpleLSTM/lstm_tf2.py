...
with open('C:/Users/JasonA1/Documents/pythonscripts/fever_simple/SimpleLSTM/data/fever/3-class/label_3', 'r') as f:
    labels_org = f.read()

with open('C:/Users/JasonA1/Documents/pythonscripts/fever_simple/SimpleLSTM/data/fever/3-class/sentence_3', 'r', encoding="utf-8") as f:
    sentences = f.read()

with open('C:/Users/JasonA1/Documents/pythonscripts/fever_simple/SimpleLSTM/data/fever/3-class/claim_3', 'r', encoding="utf-8") as f:
    claims = f.read()
...
with tf.name_scope("RNN1"):
    # Stack up multiple LSTM layers, for deep learning
    cell1 = tf.nn.rnn_cell.MultiRNNCell([lstm_cell() for _ in range(lstm_layers)])
...
with tf.name_scope('predictions'):
    predictions = _layers.fully_connected(outputs1[:,-1], 1 ,activation_fn=tf.sigmoid)
